...
} from "./chunk-6NI6IZF7.js";
import {
  y
} from "./chunk-7ZCGFTZE.js";
import {
  W3mFrameConstants,
  W3mFrameHelpers,
  W3mFrameRpcConstants
} from "./chunk-EPQFMYJR.js";
import "./chunk-AOC2VE3P.js";
import "./chunk-EPZOJKFX.js";
import {
  ConstantsUtil2,
  NetworkUtil
} from "./chunk-KKRFYSBQ.js";
...
import {
  ...
  watchConnectors,
  writeContract
} from "./chunk-TEF7IS3Y.js";
import "./chunk-DQHR7A6K.js";
import "./chunk-SA52Q66X.js";
import "./chunk-MOIOK2GB.js";
import "./chunk-6MWCIZWZ.js";
import "./chunk-5TXLSLX5.js";
import "./chunk-FVSBVWAL.js";
import "./chunk-AHQQRTYA.js";
import {
  formatUnits
  ...
  constructor(options) {
    ...
    const networkControllerClient = {
      ...
      getApprovedCaipNetworksData: async () => new Promise((resolve) => {
        ...
        if (((_a = connection == null ? void 0 : connection.connector) == null ? void 0 : _a.id) === ConstantsUtil.AUTH_CONNECTOR_ID) {
          resolve(getEmailCaipNetworks());
        } else if (((_b = connection == null ? void 0 : connection.connector) == null ? void 0 : _b.id) === ConstantsUtil.WALLET_CONNECT_CONNECTOR_ID) {
    ...
    const connectionControllerClient = {
      connectWalletConnect: async (onUri) => {
        ...
        if (((_b = siweConfig == null ? void 0 : siweConfig.options) == null ? void 0 : _b.enabled) && typeof (provider == null ? void 0 : provider.authenticate) === "function") {
          const { SIWEController, getDidChainId, getDidAddress } = await import("./exports-6L2QDZXK.js");
      ...
      disconnect: async () => {
        ...
        if ((_a = siweConfig == null ? void 0 : siweConfig.options) == null ? void 0 : _a.signOutOnDisconnect) {
          const { SIWEController } = await import("./exports-6L2QDZXK.js");
      ...
      getEnsAddress: async (value) => {
        ...
        try {
          ...
          let ensName = false;
          let wcName = false;
          if (value == null ? void 0 : value.endsWith(ConstantsUtil2.WC_NAME_SUFFIX)) {
